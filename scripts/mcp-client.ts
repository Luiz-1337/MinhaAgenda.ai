 ...
 *   MCP_CLIENT_MODEL=gpt-5.4-mini-2026-03-17
 */
...
async function main() {
  ...
  const model = process.env.MCP_CLIENT_MODEL || "gpt-5.4-mini-2026-03-17"
  const fallbackModel = process.env.MCP_CLIENT_FALLBACK_MODEL || "gpt-5.4-mini-2026-03-17"
