      ...
      <div className="relative w-full max-w-lg bg-card border border-border rounded-lg z-40 flex flex-col animate-in zoom-in-95 duration-200 overflow-hidden">
        ...
        <div className="p-6 border-b border-border flex justify-between items-center bg-muted/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-foreground tracking-tight">Novo Contato</h2>
              <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider">Cadastro de cliente</p>
            </div>
          </div>
          <button
            onClick={handleClose}
