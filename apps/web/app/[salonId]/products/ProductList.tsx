        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar">
          {isLoading ? (
            ...
            filteredProducts.map((product, index) => (
              ...
              >
                <div className="col-span-4 pl-2 font-semibold text-slate-700 dark:text-slate-200 truncate flex items-center gap-2">
                  <Tag size={14} className="text-slate-400" />
                  {product.name}
                </div>

                <div className="col-span-4 text-slate-500 dark:text-slate-400 text-xs truncate" title={product.description || ""}>
                  {product.description || "—"}
                </div>

                <div className="col-span-2 text-slate-600 dark:text-slate-300 font-mono text-xs font-medium flex items-center gap-1">
