    ...
    <div className="flex items-center justify-center min-h-[80vh] px-4">
      <div className="max-w-lg w-full">
        ...
        <div className="flex justify-center mb-6">
          <div className="p-4 rounded-full bg-amber-50 dark:bg-amber-950 border border-amber-200 dark:border-amber-800">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
          {/* Solo */}
          <div className="rounded-md border border-border bg-card p-5 flex flex-col">
            <h3 className="text-lg font-bold text-foreground">Solo</h3>
            <p className="text-2xl font-bold text-accent mt-1">
              R$ 299<span className="text-sm font-normal text-muted-foreground">/mes</span>
            </p>
            ...
            <button
              ...
              className="mt-4 w-full py-2.5 bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg text-sm font-bold transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
            >
          ...
          {/* Pro */}
          <div className="rounded-md border-2 border-accent/30 bg-card p-5 flex flex-col relative">
            <span className="absolute -top-2.5 left-4 px-2 py-0.5 bg-accent text-accent-foreground text-[10px] font-bold uppercase rounded-full tracking-wider">
              Popular
            </span>
            <h3 className="text-lg font-bold text-foreground">Pro</h3>
            <p className="text-2xl font-bold text-accent mt-1">
              R$ 999<span className="text-sm font-normal text-muted-foreground">/mes</span>
            </p>
            <ul className="mt-3 space-y-1.5 text-xs text-muted-foreground flex-1">
              <li>Ate 3 Saloes</li>
              <li>3 Agentes IA</li>
            ...
            <button
              ...
              disabled={loading !== null}
              className="mt-4 w-full py-2.5 bg-accent hover:bg-accent/90 text-accent-foreground rounded-sm text-sm font-bold transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
            >
        ...
        <div className="flex flex-col gap-3 items-center">
          <button
            ...
            disabled={loading !== null}
            className="text-sm text-accent hover:text-accent/80 font-medium flex items-center gap-1.5 disabled:opacity-50"
          >
            <RefreshCw size={14} />
